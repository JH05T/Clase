...
Public Class Alumnos
    ...
    Private Sub ButtonAyuda_Click(sender As Object, e As EventArgs) Handles ButtonAyuda.Click
        ...
        ' Define una variable "ruta" que contiene la ruta del archivo "DocAlumnos.pdf" en el directorio de inicio de la aplicación.
        Dim ruta As String = Application.StartupPath.Substring(0, Application.StartupPath.Length - 25) + "Doc\DocAlumnos.pdf"
